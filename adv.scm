...
(define-class (thing name)
  ...
  (method (owner) (lambda (obj) (ask obj 'possessor)))
  (method (name) (lambda (obj) (ask obj 'name)))
  (method (type) 'thing)
  (method (possessor) (lambda (obj) (ask obj 'possessor)))
  (method (change-possessor) (lambda (new-possessor)
